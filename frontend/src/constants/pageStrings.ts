...
export const PAGE_STRINGS = {
  ...
  searchForm: {
    ...
    perNight: '/night',
    verifiedHotelsOption: (count: number, minPrice: number) =>
      `${count} verified hotels from ₹${minPrice.toLocaleString('en-IN')}/night`,
  },
  ...
  results: {
    ...
    filters: {
      ...
      perksAndInclusions: 'Perks & Inclusions',
      nightlyBudget: 'Nightly Budget',
      resetBudgetTitle: 'Reset budget filter',
      resetBudgetAria: 'Reset price filter',
      resetBudgetBtn: 'Reset',
      sliderAriaLabel: 'Filter maximum nightly rate',
      allPrices: 'All Prices',
      under3k: '< ₹3,000',
      between3kAnd6k: '₹3,000–₹6,000',
      above6k: '> ₹6,000',
      verifiedStaySingle: 'verified stay',
      verifiedStaysPlural: 'verified stays',
    ...
    pagination: {
      ...
      currentPageAriaLabel: (page: number | string) => `Current page, page ${page}`,
      previousAriaLabel: 'Go to previous page',
      nextAriaLabel: 'Go to next page',
      summaryText: (start: number, end: number, total: number) =>
        `Showing ${start}–${end} of ${total} verified stays`,
    },
    ...
    savePrefix: 'Save',
    nightUnit: '/ night',
    wholesaleRatePrefix: 'Wholesale Rate',
    compareVs: 'vs',
    cheaperBadgeSuffix: 'cheaper',
    lessBadgeSuffix: 'less',
    emptyState: {
